...
class TrainingUserController extends Controller
{
    ...
    public function getUserNik()
    {
        ...
        {
        $dataTrainingRole = HrisDatadirisMasteruser::orderBy('nik', 'asc')  // Mengurutkan berdasarkan NIK
        ->orderBy('name', 'asc')  // Mengurutkan berdasarkan Nama User
...
public function edit($id)
{
    ...
    $role = HrisDatadirisMasteruser::findOrFail($id);
...
{
    try {
        $role = HrisDatadirisMasteruser::findOrFail($id);  // Temukan role berdasarkan ID
